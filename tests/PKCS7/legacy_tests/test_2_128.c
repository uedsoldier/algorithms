...
#define BLOCK_SIZE PKCS7_BLOCK_SIZE_128_BIT

const char *TEST_STRING = "12";
const char *TEST_NAME = "PKCS7 test with input size: 2 - block size: 128 bits";
...
int main(int argc, char *argv[])
{
    ...
    PKCS7_error_t code = PKCS7_add_padding(&padding_struct, input_string, input_string_len, PKCS7_BLOCK_SIZE_128_BIT);
