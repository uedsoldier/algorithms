...
int main(int argc, char *argv[]){
    ...
    AES256_code = AES256_CBC_encrypt(&AES256_ctx, input_string, AES256_encrypt_buffer, test_string_len, &output_len);
    ...
    AES256_code = AES256_CBC_decrypt(&AES256_ctx, AES256_encrypt_buffer, AES256_decrypt_buffer, test_string_len, &output_len);
