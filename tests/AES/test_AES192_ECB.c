...
typedef struct {
    ...
    const uint8_t key[AES192_FIXED_KEY_SIZE];  // Changed to uint8_t
...
static const TestCase test_cases[] = {
    {.AES192_ctx = {0},
     ...
     .key = {'A', 'E', 'S', '1', '9', '2', '_', 'S', 'E', 'C', 'R', 'E',
             'T', '_', 'K', 'E', 'Y', '_', '2', '4', 'B', 'Y', 'T', 'E'},
    ...
    {.AES192_ctx = {0},
     ...
     .key = {'S', 'E', 'C', 'R', 'E', 'T', 'K', 'E', 'Y', '1', '2', '3',
             '4', '5', '6', '7', '2', '4', 'B', 'Y', 'T', 'E', 'S', '!'},
    ...
    {.AES192_ctx = {0},
     .AES192_code = AES_CODE_OK,
     .input_string =
         "This is a test string for AES-192 ECB mode without padding!",
     .key = {'A', 'E', 'S', '1', '9', '2', '_', 'S', 'E', 'C', 'R', 'E',
             'T', '_', 'K', 'E', 'Y', '_', '2', '4', 'B', 'Y', 'T', 'E'},
...
int main(void) {
    ...
    for (size_t i = 0; i < TOTAL_TESTS; i++) {
        ...
        AES192_init_ctx(&test.AES192_ctx, test.key, NULL);

        // Encrypt
        test.AES192_code = AES192_ECB_encrypt(
            &test.AES192_ctx, test.input_string, test.AES192_encrypt_buffer,
        ...
        test.AES192_code =
            AES192_ECB_decrypt(&test.AES192_ctx, test.AES192_encrypt_buffer,
                               test.AES192_decrypt_buffer, test.output_len,
        ...
        if (test.usePKCS7) {
            test_passed = (decrypted_len == test.input_string_len) &&
                          (memcmp(test.input_string, test.AES192_decrypt_buffer,
