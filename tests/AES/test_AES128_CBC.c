...
int main(int argc, char *argv[]){
    ...
    AES128_code = AES128_CBC_encrypt(&AES128_ctx, input_string, AES128_encrypt_buffer, test_string_len, &output_len);
    ...
    AES128_code = AES128_CBC_decrypt(&AES128_ctx, AES128_encrypt_buffer, AES128_decrypt_buffer, test_string_len, &output_len);
