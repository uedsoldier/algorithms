...
static const char *TEST_NAME = "AES-128 CBC tester";  // Fixed test name
...
typedef struct
{
    ...
    const char init_vector[AES_BLOCK_LEN];  // Added IV field
...
static const TestCase test_cases[] = {
    ...
    {.input_string = "Special chars: !@#$%^&*()_+-=[]{}|;':\",./<>?",
     ...
     .usePKCS7 = true},
    {.input_string = "This is a test string for AES-128 CBC mode without padding!",
     .key = "AES128_SECRET_KEY", // 16-byte key
     .init_vector = "1234567890123456", // 16-byte IV
...
int main(void)
{
    ...
    for (size_t i = 0; i < TOTAL_TESTS; i++)
    {
        ...
        AES128_init_ctx(&test.AES128_ctx, (const uint8_t *)test.key, (const uint8_t *)test.init_vector);

        // Encrypt
        test.AES128_code = AES128_CBC_encrypt(  // Changed to CBC mode
            &test.AES128_ctx,
        ...
        test.AES128_code = AES128_CBC_decrypt(  // Changed to CBC mode
            &test.AES128_ctx,
            test.AES128_encrypt_buffer,
