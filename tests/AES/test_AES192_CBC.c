...
int main(int argc, char *argv[]){
    ...
    AES192_code = AES192_CBC_encrypt(&AES192_ctx, input_string, AES192_encrypt_buffer, input_string_len, &output_len);
    ...
    AES192_code = AES192_CBC_decrypt(&AES192_ctx, AES192_encrypt_buffer, AES192_decrypt_buffer, input_string_len, &output_len);
