...
typedef enum crc_t {
   //CRC8
   CRC8_CCITT, CRC8_CDMA2000, CRC8_DARC, CRC8_DVB_S2, CRC8_EBU, CRC8_I_CODE, CRC8_ITU, CRC8_MAXIM, CRC8_ROHC, CRC8_WCDMA,
   CRC8_SAE_J1850, CRC8_SAE_J1850_ZERO, CRC8_8H2F,
   //CRC16
   CRC16_XMODEM, CRC16_AUG_CCITT, CRC16_CCITT_FALSE, CRC16_GENIBUS, CRC16_CCITT_KERMIT, CRC16_TMS37157,
   CRC16_RIELLO, CRC16_A, CRC16_MCRF4XX, CRC16_X25, CRC16_ARC, CRC16_BUYPASS, CRC16_DDS110, CRC16_MAXIM, CRC16_USB,
   CRC16_MODBUS, CRC16_DECT_X, CRC16_DECT_R, CRC16_DNP, CRC16_EN13757, CRC16_T10_DIF, CRC16_TELEDISK, CRC16_CDMA2000,
   //CRC32
...
*/
const uint8_t CRC8_0x07_table[256] = {
...
*/
const uint8_t CRC8_0x1D_table[256] = {
...
*/
const uint8_t CRC8_0x2F_table[256] = {
...
*/       
const uint8_t CRC8_0x31_table[256] = {
...
*/       
const uint8_t CRC8_0x39_table[256] = {
...
*/   
const uint8_t CRC8_0x9B_table[256] = {
...
*/      
const uint8_t CRC8_0xD5_table[256] = {
...
*/           
const uint16_t CRC16_0x8005_table[256] = {
...
*/          
const uint16_t CRC16_0x0589_table[256] = {
...
*/      
const uint16_t CRC16_0x3D65_table[256] = {
...
*/           
const uint16_t CRC16_0x8BB7_table[256] = {
...
*/         
const uint16_t CRC16_0xA097_table[256] = {
...
*/        
const uint16_t CRC16_0xC867_table[256] = {
...
*/     
const uint32_t CRC32_0xA833982B_table[256] = {
...
*/      
const uint32_t CRC32_0x814141AB_table[256] = {
...
*/        
const uint32_t CRC32_0x1EDC6F41_table[256] = {
...
*/      
const uint32_t CRC32_0x04C11DB7_table[256] = {
...
*/    
const uint32_t CRC32_0x000000AF_table[256] = {
...
*/      
const uint32_t CRC32_0x32583499_table[256] = {
...
*/       
const uint32_t CRC32_0x741B8CD7_table[256] = {
   //Pendiente por implementar
};
#endif
