...
/**
 * @brief Macro para implementación de tablas previamente generadas para CRC8
 * con base en su polinomio generador. Cada tabla utiliza 256 bytes extra de
 * memoria de programa, pero incrementa sustancialmente la velocidad de
 * ejecución.
 */
#define CRC8_USE_LOOKUP_TABLE 0

/**
 * @brief Macro para implementación de tablas previamente generadas para CRC16
 * con base en su polinomio generador. Cada tabla utiliza 512 bytes extra de
 * memoria de programa, pero incrementa sustancialmente la velocidad de
 * ejecución.
 */
...
/**
 * @brief Macro para implementación de tablas previamente generadas para CRC32
 * con base en su polinomio generador. Cada tabla utiliza 1024 bytes extra de
 * memoria de programa, pero incrementa sustancialmente la velocidad de
 * ejecución.
 */
...
/**
 * @brief Definición de enumeración de tipo CRC, con los nombres de los
 * algoritmos CRC implementados de 8, 16 y 32 bits
 */
typedef enum crc_t {
    // CRC8
    CRC8_CCITT = 0,
...
// Funciones de obtención de valores iniciales (semilla) de CRC para 8, 16 y 32
// bits.
...
// Función para verificación de valor de entrada reflejada (input reflected) de
// CRC para 8, 16 y 32 bits.
static bool CRC_getInputReflected(crc_t crc_type);

// Función para verificación de valor de salida reflejada (output reflected) de
// CRC para 8, 16 y 32 bits.
static bool CRC_getOutputReflected(crc_t crc_type);

// Funciones para obtención de valor de máscara XOR de valor de salida de CRC
// para 8, 16 y 32 bits.
...
// Funciones para obtención de CRC para 8, 16 y 32 bits. Múltiples
// implementaciones.
